...
namespace Order.Domain.Entities
{
    public sealed record OrderLocation : ModelBase
    {
        ...
        public EStatus StatusOrder { get; set; } = EStatus.Ativo;
        ...
        public void CalculateFineRates(DateTime datePreview)
        {
            DatePrev = DateOnly.FromDateTime(datePreview);
            var days = DateEnd.DayNumber - DatePrev.DayNumber;
            StatusOrder = EStatus.Encerrado;
